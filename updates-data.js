const CONFIG = {
    ANNOUNCEMENT_VERSION: 'v1.4.3',
    UPDATE_DATE: '2026.9.16'
};
...
const updatesData = [
    {
        date: "2026.9.16",
        badge: "v1.4.3",
        title: "面包屑导航与新配合物专文上线",
        desc: "新增面包屑导航，提升用户在网站内的导航体验；同时上线了新配合物专文氯化三(2,2'-联吡啶)合铜，深入解析其晶体结构与独特性质。",
    },
    {
        date: "2026.9.9",
        badge: "v1.4.2",
        title: "氯化三(2,2'-联吡啶)合铜专文上线",
        desc: "配合物新专文：氯化三(2,2'-联吡啶)合铜的晶体结构与独特性质解析，深入了解其在化学领域的应用与研究价值。",
    },
    {
        date: "2026.8.28",
        badge: "v1.4.1",
